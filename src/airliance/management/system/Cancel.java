...
public class Cancel extends JFrame implements ActionListener{
    ...
    public Cancel() {
        ...
        add(heading);
         ...
         ImageIcon i1=new ImageIcon("C:/Users/aritr/OneDrive/Desktop/airliance recommendation/icons-20240928T115136Z-001/icons/cancel.jpg");
        Image i2=i1.getImage().getScaledInstance(300, 230, Image.SCALE_DEFAULT);
        ImageIcon image= new ImageIcon(i2);
        
        JLabel lblimage=new JLabel(image);
        lblimage.setBounds(450, 115, 300, 230);
        add(lblimage);
